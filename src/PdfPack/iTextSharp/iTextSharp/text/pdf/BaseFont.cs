...
namespace iTextSharp.text.pdf
{
    ...
    public abstract class BaseFont {
        ...
        */
        ...
        /// 外字フォントの生成
        /// </summary>
        /// <param name="eudcFontFileName">EUDC.tteファイルのフルパス</param>
        /// <param name="encoding">エンコーディング</param>
        /// <returns></returns>
        public static BaseFont CreateEudcFont(string eudcFontFileName, string encoding)
            => new EudcFont(eudcFontFileName, NormalizeEncoding(encoding));
